...
class SecurityControllerTest extends WebTestCase
{
    ...
    public function testLogin(): void
    {
        ...
        // when
        $crawler = $this->httpClient->request('GET', '/pl/login');
        ...
        $this->assertSelectorTextContains('body > .container-fluid > .alert', 'Jesteś zalogowany jako user@example.com');
    }
    ...
    public function testLoginUser(): void
    {
        ...
        // when
        $this->httpClient->request('GET', '/pl/login');
